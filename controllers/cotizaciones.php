...
class cotizaciones
{
    ...
    public function detalles()
    {
        ...
        require_once "views/layout/header_main.php";
        require_once "views/cotizaciones/" . $url[0] . "/detalles.php";
        require_once "views/layout/footer_main.php";
    }
    ...
    public function descargar()
    {
        ...
        require_once "views/cotizaciones/" . $url[0] . "/descargar.php";
    }
    ...
    public function emitir()
    {
        ...
        if (
            ...
            header("Location:" . constant("url") . "cotizaciones/detalles/auto/$id/No se puede emitir, la cotizacion esta vencida.");
            exit();
        }

        if ($_POST) {
            if ($url[0] == "auto") {
                $alerta = $this->emitir_auto($api, $cotizacion, $id);
            }
        }

        require_once "views/layout/header_main.php";
        require_once "views/cotizaciones/" . $url[0] . "/emitir.php";
        require_once "views/layout/footer_main.php";
    }
    ...
    public function reporte()
    {
        ...
        if (isset($_POST["pdf"]) and $_POST["tipo_reporte"] == "auto") {
            ...
            require_once "views/cotizaciones/auto/descargar_reporte.php";
            exit();
        }
    ...
    public function crear()
    {
        ...
        require_once "views/layout/header_main.php";
        if (isset($url[0])) {
            require_once "views/cotizaciones/" . $url[0] . "/crear.php";
        } else {
    ...
    public function crear_auto($api)
    {
        ...
        header("Location:" . constant("url") . "cotizaciones/detalles/auto/$nuevo_cotizacion_id");
        exit();
    }

    public function emitir_auto($api, $cotizacion, $id)
    {
        if (!empty($_FILES["cotizacion_firmada"]["name"])) {
            ...
            if (!in_array($extension, $permitido)) {
                ...
                if (empty($_POST["cliente_id"])) {
                    $cliente_nuevo["Name"] = $_POST["rnc_cedula"];
                    ...
                    $cliente_nuevo["Nombre"] = $_POST["nombre"];
                ...
                header("Location:" . constant("url") . "tratos/detalles/auto/" . $nuevo_trato_id);
                exit();
            }
        }
    }
