...
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item"><a href="<?= site_url("cotizaciones/descargar/" . $cotizacion->getEntityId()) ?>">Descargar</a></li>
    <li class="breadcrumb-item"><a href="<?= site_url("cotizaciones/documentos/" . $cotizacion->getEntityId()) ?>">Documentos</a></li>
    <li class="breadcrumb-item"><a href="<?= site_url("polizas/emitir/" . $cotizacion->getEntityId()) ?>">Emitir</a></li>
</ol>
