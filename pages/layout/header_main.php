                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?= constant("url") ?>">
                            ...
                            </div> Panel de Control <a class="nav-link" href="<?= constant("url") ?>cotizaciones/crear">
                                <div class="sb-nav-link-icon">
                                    <i class="fas fa-book-open"></i>
                                </div> Crear Cotización
                            </a> <a class="nav-link" href="<?= constant("url") ?>cotizaciones/buscar">
                                <div class="sb-nav-link-icon">
                                    <i class="fab fa-searchengin"></i>
                                </div> Buscar Cotización
                            </a> <a class="nav-link" href="<?= constant("url") ?>cotizaciones/reportes">
                                <div class="sb-nav-link-icon">
