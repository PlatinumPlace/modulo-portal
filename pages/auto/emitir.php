...
if ($_POST) {
    ...
    if (!in_array($extension, $permitido)) {
        ...
        $cliente["Direcci_n"] = $_POST["direccion"];
        $cliente["Nombre"] = $_POST["nombre"];
        $cliente["Apellido"] = $_POST["apellido"];
        $cliente["Tel_fono"] = $_POST["telefono"];
        $cliente["Tel_residencia"] = $_POST["tel_residencia"];
        $cliente["Tel_trabajo"] = $_POST["tel_trabajo"];
        $cliente["Fecha_nacimiento"] = date("Y-m-d", strtotime($_POST["fecha_nacimiento"]));
        $cliente["Email"] = $_POST["correo"];
        $cliente["RNC_C_dula"] = $_POST["rnc_cedula"];
        $cliente["Name"] = $_POST["rnc_cedula"];
        $cliente["Tipo"] = "Deudor";
        $cliente_id =  $api->crear("Clientes", $cliente);
        ...
        $bien["A_o"] = $detalles->getFieldValue('A_o_veh_culo');
        ...
        header("Location:index.php?page=detallesAuto&id=" . $_GET["id"]);
        exit();
    }
}
?>
...
<form enctype="multipart/form-data" class="row" method="POST" action="index.php?page=emitirAuto&id=<?= $_GET["id"] ?>">
