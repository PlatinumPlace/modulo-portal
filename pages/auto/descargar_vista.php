        ...
        <div class="row">
            ...
            <div class="col-2">
                ...
                <?php if (in_array($oferta->getFieldValue("Stage"), $emitida)) : ?>
                    ...
                    <br>
                <?php endif ?>
                <b>Fecha</b> <br> <?= $oferta->getFieldValue('Fecha_de_emisi_n') ?>
            </div>
                    ...
                    <?php foreach ($cotizaciones as $cotizacion) : ?>
                        <?php if ($cotizacion->getFieldValue('Grand_Total') > 0) : ?>
                            ...
                            <div class="col-2">
                                ...
                                <?php if (!in_array($oferta->getFieldValue("Stage"), $emitida)) : ?>
                                    <?php $imagen_aseguradora =  $api->downloadPhoto("Vendors", $cotizacion->getFieldValue("Aseguradora")->getEntityId(), "$ruta/") ?>
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if (!in_array($oferta->getFieldValue("Stage"), $emitida)) : ?>
                                            <?php $coberturas =$api->getRecord("Contratos", $cotizacion->getFieldValue('Contrato')->getEntityId()) ?>
                                        <?php endif ?>
                                        ...
                                        <p class="card-text">
                                            <small>
                                                ...
                                                $resultado = $oferta->getFieldValue('Valor_Asegurado') * ($coberturas->getFieldValue('Riesgos_comprensivos') / 100);
                                                ...
                                                $resultado = $oferta->getFieldValue('Valor_Asegurado') * ($coberturas->getFieldValue('Colisi_n_y_vuelco') / 100);
                                                echo "RD$" . number_format($resultado);

                                                echo "<br>";

                                                $resultado = $oferta->getFieldValue('Valor_Asegurado') * ($coberturas->getFieldValue('Incendio_y_robo') / 100);
                                                echo "RD$" . number_format($resultado);
                        ...
                        <div class="col-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <?= strtoupper($oferta->getFieldValue('Modelo')->getLookupLabel()) ?><br>
                                    <?= $oferta->getFieldValue('Chasis') ?><br>
                                    <?= $oferta->getFieldValue('Fecha_de_emisi_n') ?><br>
