<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	...
	<div class="btn-toolbar mb-2 mb-md-0">
		<div class="btn-group mr-2">
			...
			<?php else : ?>
				<a href="<?= constant("url") ?>emitir_auto/<?= $id ?>" class="btn btn-sm btn-outline-secondary">Emitir</a>
			<?php endif ?>

			<a href="<?= constant("url") ?>descargar_auto/<?= $id ?>" class="btn btn-sm btn-outline-secondary">Descargar</a>
		</div>
	</div>
