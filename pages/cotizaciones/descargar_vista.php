        ...
        <div class="col-12">
            <table class="table table-sm">
                ...
                <tbody>
                    <?php
                    do {
                        $cotizaciones = $api->searchRecordsByCriteria("Quotes", $criterio, $pagina, 200);
                            ...
                            if ($post["tipo_reporte"] == "cotizaciones") {
                                if (empty($post["aseguradora_id"])) {
                                    foreach ($cotizaciones as $cotizacion) {
                                        $oferta =  $api->getRecord("Deals", $cotizacion->getFieldValue("Deal_Name")->getEntityId());
                                        if (
                                            date("Y-m-d", strtotime($oferta->getFieldValue("Fecha_de_emisi_n")))  >= $post["desde"]
                                            and
                                            date("Y-m-d", strtotime($oferta->getFieldValue("Fecha_de_emisi_n"))) <= $post["hasta"]
                                            and
                                            ...
                                            echo "<tr>";
                                            echo '<th scope="col">' . date("Y-m-d", strtotime($oferta->getFieldValue("Fecha_de_emisi_n"))) . "</th>";
                                            echo "<td>" . date("Y-m-d", strtotime($oferta->getFieldValue("Closing_Date"))) . "</td>";
                                            echo "<td>" . $oferta->getFieldValue('Marca')->getLookupLabel() . "</td>";
                                            echo "<td>" . $oferta->getFieldValue('Modelo')->getLookupLabel() . "</td>";
                                            echo "<td>" . $oferta->getFieldValue('Tipo_de_veh_culo') . "</td>";
                                            echo "<td>" . number_format($oferta->getFieldValue('Valor_Asegurado'), 2) . "</td>";
                                    ...
                                    foreach ($cotizaciones as $cotizacion) {
                                        ...
                                        if (
                                            ...
                                            $cotizacion->getFieldValue('Grand_Total') > 0
                                            and
                                            $cotizacion->getFieldValue("Aseguradora")->getEntityId() == $post["aseguradora_id"]
                                        ) {
                                            $prima_sumatoria += $oferta->getFieldValue('Valor_Asegurado');
                                            $valor_sumatoria += $cotizacion->getFieldValue('Grand_Total');
