...
<div class="card-deck">
    ...
    <div class="card text-white bg-primary mb-5" style="max-width: 18rem;">
        ...
        <div class="card-body">
            <h5 class="card-title"><?= $cotizaciones_total ?></h5>
            <a href="<?= constant("url") ?>buscar" class="stretched-link"> </a>
        </div>
    </div>
    ...
    <div class="card text-white bg-success mb-5" style="max-width: 18rem;">
        ...
        <div class="card-body">
            <h5 class="card-title"><?= $cotizaciones_emitidas ?></h5>
            <a href="<?= constant("url") ?>buscar/emisiones_mensuales" class="stretched-link"></a>
        </div>
    </div>
    ...
    <div class="card text-white bg-danger mb-5" style="max-width: 18rem;">
        ...
        <div class="card-body">
            <h5 class="card-title"><?= $cotizaciones_vencidas ?></h5>
            <a href="<?= constant("url") ?>buscar/vencimientos_mensuales" class="stretched-link"></a>
        </div>
    </div>
