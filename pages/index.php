...
$resumenes_mensuales = $cotizaciones->resumenes_mensuales();
$cotizaciones_mensuales = $cotizaciones->cotizaciones_mensuales();
	...
	<div class="col-xl-3 col-md-6">
		<div class="card bg-warning text-white mb-4">
			<div class="card-body">
				...
				<?= $resumenes_mensuales["pendientes"] ?>
			</div>
			<div class="card-footer d-flex align-items-center justify-content-between">
	...
	<div class="col-xl-3 col-md-6">
		<div class="card bg-danger text-white mb-4">
			<div class="card-body">
				...
				<?= $resumenes_mensuales["vencimientos"] ?>
			</div>
			<div class="card-footer d-flex align-items-center justify-content-between">
...
<?php if (!empty($cotizaciones_mensuales["aseguradoras"])) : ?>
	<div class="row">
		<div class="col-xl-12">
			<div class="card mb-4">
				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="table" id="dataTable" width="100%" cellspacing="0">
							...
							<tbody>
								<?php foreach ($cotizaciones_mensuales["aseguradoras"] as $nombre => $cantidad_polizas) : ?>
									<tr>
