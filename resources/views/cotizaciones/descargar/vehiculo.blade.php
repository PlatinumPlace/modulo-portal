        ...
        <div class="row">
            ...
            <div class="col-8">
                <h4 class="text-uppercase text-center">
                    cotización <br> seguro vehí­culo de motor <br> Plan Mensual {{ $detalles->getFieldValue('Plan') }}
                </h4>
            </div>
                            ...
                            <div class="col-2">
                                <div class="card border-0">
                                    ...
                                    <div class="card-body small">
                                        ...
                                        <p>
                                            <br>
                                            RD$ {{ number_format($planDetalles->getFieldValue('Da_os_propiedad_ajena')) }}
                                            <br>
                                            RD$ {{ number_format($planDetalles->getFieldValue('Lesiones_muerte_1_pers')) }}
                                            <br>
                                            RD$
                                        ...
                                        <p>
                                            RD$ {{ number_format($planDetalles->getFieldValue('Riesgos_conductor')) }} <br>
                                            RD$ {{ number_format($planDetalles->getFieldValue('Fianza_judicial')) }} <br>
                                        </p>
