...
@section('title', 'Reporte TUA' . $caso->getFieldValue('TUA'))
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-6">
            <b>Estado</b> <br>
            {{ $caso->getFieldValue('Estado_p_liza') }}
        </div>
        ...
        <div class="col-6">
            <b>Tarifa Base</b> <br>
            RD${{ number_format($servicio->getFieldValue('Unit_Price'), 2) }}
        </div>

        <div class="col-6">
            <b>Costo</b> <br>
            RD${{ number_format($caso->getFieldValue('Costo_total'), 2) }}
        </div>

        <div class="col-6">
            <b>Kilometraje</b> <br>
            {{ $caso->getFieldValue('Kilometraje') }}
        </div>

        <div class="col-6">
            <b>Tarifa por Kilometro</b> <br>
            {{ $servicio->getFieldValue('Kilometraje_adic_lineal') }}
        </div>

        <div class="col-6">
            <b>Kilometraje Loma</b> <br>
            {{ $caso->getFieldValue('Kilometraje_Loma') }}
        </div>

        <div class="col-6">
            <b>Tarifa por Kilometro Loma</b> <br>
            {{ $servicio->getFieldValue('Kilometraje_adic_loma') }}
        </div>

        <div class="col-6">
            <b>Extracción</b> <br>
            RD${{ number_format($caso->getFieldValue('Extracci_n'), 2) }}
        </div>

        <div class="col-6">
            <b>Peaje</b> <br>
            RD${{ number_format($caso->getFieldValue('Peaje'), 2) }}
        </div>
        ...
        <div class="col-6">
            <b>Diferencia</b> <br>
            RD${{ number_format($caso->getFieldValue('Diferencia'), 2) }}
        </div>
        ...
        <div class="col-6">
            ...
            {{ date('H:i:s A', strtotime($caso->getFieldValue('Despachado'))) }}
        </div>
