...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card mb-4">
                <div class="card-body">
                    <form enctype="multipart/form-data" method="POST" action=" {{ route('polizaAuto.store') }}">
                        @csrf
                        ...
                        <input type="text" value="{{ $detalles->getFieldValue('Marca')->getLookupLabel() }}" name="marca"
                            hidden>
                        <input type="text" value="{{ $detalles->getFieldValue('Modelo')->getLookupLabel() }}" name="modelo"
                            hidden>
