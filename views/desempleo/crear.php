<h1 class="mt-4 text-uppercase">crear cotización desempleo</h1>

<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item"><a href="<?= constant("url") ?>">Panel de Control</a></li>
    <li class="breadcrumb-item active"><a href="<?= constant("url") ?>cotizaciones/crear">Crear</a></li>
    <li class="breadcrumb-item active"><a href="<?= constant("url") ?>desempleo/crear">Desempleo</a></li>
</ol>
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="<?= constant("url") ?>desempleo/crear">
