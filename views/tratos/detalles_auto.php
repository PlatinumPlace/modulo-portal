...
<ol class="breadcrumb mb-4">
    ...
    <li class="breadcrumb-item"><a href="<?= constant("url") ?>tratos/detalles_auto/<?= $id ?>">No. <?= $trato->getFieldValue('No_Emisi_n') ?></a></li>
</ol>
    ...
    <div class="col-lg-10">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <a href="<?= constant("url") ?>tratos/descargar_auto/<?= $id ?>" class="btn btn-secondary">Descargar</a>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-end">
                            <li class="page-item">
                                <a class="page-link" href="<?= constant("url") ?>tratos/detalles_auto/<?= $id ?>/<?= $num_pagina - 1 ?>">Anterior</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="<?= constant("url") ?>tratos/detalles_auto/<?= $id ?>/<?= $num_pagina + 1 ?>">Siguente</a>
                            </li>
                        </ul>
                    </nav>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" readonly class="form-control-plaintext" value="<?= $bien->getFieldValue('Chasis') ?>">
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" readonly class="form-control-plaintext" value="<?= $cliente->getFieldValue('Name') ?>">
                            </div>
                        </div>
