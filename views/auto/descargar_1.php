...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-2">
                <img src="public/img/logo.png" alt="60" width="100" height="100">
            </div>
                ...
                <div class="row">
                    ...
                    foreach ($cotizaciones as $cotizacion) {
                        if ($cotizacion->getFieldValue('Grand_Total') > 0) {
                            ...
                            $imagen =  $auto->downloadPhoto("Vendors", $cotizacion->getFieldValue('Aseguradora')->getEntityId());
                            echo '<img src="' . $imagen . '" height="43" width="90" class="card-img-top">';
                            echo '<div class="card-body small">';

                            $coberturas =  $auto->getRecord("Contratos", $cotizacion->getFieldValue('Contrato')->getEntityId());
