<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <h3 class="header center orange-text">Editar Cotización No. <?= $resultado['trato']->getFieldValue('No_de_cotizaci_n') ?></h3>
    </div>
</div>
...
<div class="container">
    <div class="section">
        ...
        <div class="row">
            <form class="col s12" method="post" action="?pagina=editar&id=<?= $resultado['trato']->getEntityId() ?>">
                <div class="row">
