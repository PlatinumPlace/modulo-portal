        ...
        <div class="card mb-4">
            <div class="card-body">
                <?php if ($cotizacion->getFieldValue('Deal_Name') == null) : ?>
                    <a href="<?= constant("url") ?>cotizaciones/emitir/auto/<?= $id ?>" class="btn btn-primary">Emitir</a>
                <?php else : ?>
                    <a href="<?= constant("url") ?>tratos/detalles/auto/<?= $cotizacion->getFieldValue('Deal_Name')->getEntityId() ?>" class="btn btn-success">Ver Emisión</a>
                <?php endif ?>
                <a href="<?= constant("url") ?>cotizaciones/descargar/auto/<?= $id ?>" class="btn btn-secondary">Descargar</a>
            </div>
        </div>
