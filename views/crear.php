...
<div class="row">
    ...
    <?php if (isset($auto)) : ?>
        <div class="card col-3">
            ...
            <a class="small text-white  stretched-link" href="?pagina=crearAuto"></a>
    ...
    <?php if (isset($vida)) : ?>
        <div class="card col-3">
            ...
            <a class="small text-white  stretched-link" href="?pagina=crearVida"></a>
    ...
    <?php if (isset($incendio)) : ?>
        <div class="card col-3">
            ...
            <a class="small text-white  stretched-link" href="?pagina=crearIncendio"></a>
