            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a href="<?= constant("url") ?>cerrar_sesion" class="dropdown-item" onclick="return confirm('¿Deseas cerrar Sesión?')">Cerrar Sesión</a>
                    </div>
                </li>
            </ul>
        </nav>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?= constant("url") ?>buscar">
                                <div class="sb-nav-link-icon">
