...
$bien = detalles("Bienes", $trato->getFieldValue('Bien')->getEntityId());
$coberturas = detalles("Contratos", $trato->getFieldValue('Contrato')->getEntityId());
?>
<!doctype html>
<html lang="en">
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-8">
                <h4 class="text-uppercase text-center">
                    ...
                    Plan <?= $trato->getFieldValue('Deal_Name') ?>
                </h4>
            </div>
    ...
    <script>
        ...
        setTimeout(function() {
            window.print();
            window.location = url + "emisiones/detalles?tipo=auto&id=" + id;
        }, time);
    </script>
