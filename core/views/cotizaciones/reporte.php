        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="<?= constant("url") ?>cotizaciones/reporte">
                    ...
                    <div class="form-group row">
                        <label for="estado_cotizacion" class="col-sm-3 col-form-label">Estado de cotización</label>
                        <div class="col-sm-9">
                            <select name="estado_cotizacion" id="estado_cotizacion" class="form-control">
                                <option value="Negociacion" selected>Negociación</option>
