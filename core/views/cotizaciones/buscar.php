...
<table class="table">
    ...
    <tbody>
        ...
        foreach ($lista as $detalles) {
            ...
            echo '<a href="' . constant("url") . "$tipo/detalles?id=" . $detalles->getEntityId() . '" title="Detalles"><i class="fas fa-info-circle"></i></a>';
            echo "&nbsp;";
            echo '<a href="' . constant("url") . "$tipo/emitir?id=" . $detalles->getEntityId() . '" title="Emitir"><i class="fas fa-user"></i></i></a>';
            echo "&nbsp;";
            echo '<a href="' . constant("url") . "$tipo/descargar?id=" . $detalles->getEntityId() . '" title="Descargar"><i class="fas fa-file-download"></i></a>';
            echo "</td>";
            echo "</tr>";
        }
        ?>
