        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form enctype="multipart/form-data" method="POST" action="<?= constant("url") ?>cotizaciones/emitir_auto/<?= $id ?>">
                    ...
                    <div id="nuevo">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="rnc_cedula" name="rnc_cedula" maxlength="11">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="chasis">Chasis <small>(sin guiones,solo números y letras)</small></label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="aseguradora_id" name="aseguradora" class="form-control">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" class="form-control-file" name="cotizacion_firmada" id="cotizacion_firmada">
                        </div>
                    </div>
