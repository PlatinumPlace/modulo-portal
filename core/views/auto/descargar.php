                    ...
                    <?php foreach ($cotizaciones as $cotizacion) : ?>
                        <?php if ($cotizacion->getFieldValue('Grand_Total') > 0) : ?>
                            ...
                            <div class="col-2">
                                ...
                                <?php if (!in_array($resumen->getFieldValue("Stage"), $emitida)) : ?>
                                    <?php $imagen_aseguradora =  $this->downloadPhoto("Vendors", $cotizacion->getFieldValue("Aseguradora")->getEntityId(), "$ruta/") ?>
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if (!in_array($resumen->getFieldValue("Stage"), $emitida)) : ?>
                                            <?php $coberturas = $this->getRecord("Contratos", $cotizacion->getFieldValue('Contrato')->getEntityId()) ?>
                                        <?php endif ?>
