                    ...
                    <?php foreach ($detalles as $info) : ?>
                        <?php if ($info->getFieldValue('Grand_Total') > 0) : ?>
                            ...
                            <div class="col-2">
                                ...
                                <?php if (!in_array($resumen->getFieldValue("Stage"), $emitida)) : ?>
                                    <?php constant("url") . $imagen_aseguradora = $this->cotizacion->foto_aseguradora($info->getFieldValue("Aseguradora")->getEntityId()) ?>
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php $coberturas = $this->cotizacion->contrato_detalles($info->getFieldValue('Contrato')->getEntityId()) ?>

                                        <p class="card-text">
                                            <small>
                                                <?php

                                                $resultado = $resumen->getFieldValue('Valor_Asegurado') * ($coberturas->getFieldValue('Riesgos_comprensivos') / 100);
                                                ...
                                                $resultado = $resumen->getFieldValue('Valor_Asegurado') * ($coberturas->getFieldValue('Colisi_n_y_vuelco') / 100);
                                                echo "RD$" . number_format($resultado);

                                                echo "<br>";

                                                $resultado = $resumen->getFieldValue('Valor_Asegurado') * ($coberturas->getFieldValue('Incendio_y_robo') / 100);
                                                echo "RD$" . number_format($resultado);
                        ...
                        <div class="col-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <?= strtoupper($resumen->getFieldValue('Modelo')->getLookupLabel()) ?><br>
                                    <?= $resumen->getFieldValue('Chasis') ?><br>
                                    <?= $resumen->getFieldValue('Fecha_de_emisi_n') ?><br>
