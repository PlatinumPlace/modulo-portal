    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php if ($cotizacion->getFieldValue('Nombre') == null) : ?>
                <a href="<?= constant('url') ?>auto/completar_cotizacion/<?= $cotizacion->getEntityId() ?>" class="btn btn-primary">Siguiente</a>
            <?php else : ?>
                <a href="<?= constant('url') ?>cotizaciones/emitir_cotizacion/<?= $cotizacion->getEntityId() ?>" class="btn btn-success">Emitir</a>
                <a href="<?= constant('url') ?>auto/descargar_cotizacion/<?= $cotizacion->getEntityId() ?>" class="btn btn-info">Descargar</a>
            <?php endif ?>
