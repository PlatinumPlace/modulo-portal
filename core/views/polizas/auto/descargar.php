...
$imagen_aseguradora = $polizas->imagenAseguradora($detalles->getFieldValue('Aseguradora')->getEntityId());
$cliente = $polizas->detallesCliente($detalles->getFieldValue('Cliente')->getEntityId());
$bien = $polizas->detallesBien($detalles->getFieldValue('Bien')->getEntityId());
$aseguradora = $polizas->detallesAseguradora($detalles->getFieldValue('Aseguradora')->getEntityId());
$coberturas = $polizas->coberturas($detalles->getFieldValue('Contrato')->getEntityId());
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <b>Póliza No.</b> <br> <?= $detalles->getFieldValue('P_liza')->getLookupLabel() ?> <br>
            </div>
    ...
    <script>
        ...
        setTimeout(function () {
            window.print();
            window.location = url + "polizas/detallesAuto?id=" + id;
        }, time);
    </script>
