...
$adjuntos = $polizas->documentoAdjuntos("Contratos", $detalles->getFieldValue('Contrato')->getEntityId());
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <a href="<?= constant("url") . "polizas/descargarAuto?id=" . $_GET["id"] ?>" class="btn btn-sm btn-outline-secondary">Descargar</a>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <?php foreach ($adjuntos as $adjunto) : ?>
                    <a href="<?= constant("url") . "polizas/detallesAuto?id=" . $_GET["id"] . '&attachment_id=' . $adjunto->getId() ?>" class="form-control-plaintext">Descargar</a>
                <?php endforeach ?>
            </div>
        </div>
