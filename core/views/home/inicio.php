  ...
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="?page=cotizacion_lista&filtro=En trámite/Emitido">Pólizas emitidas en el mes</a></div>
  ...
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><a href="?page=cotizacion_lista&filtro=En trámite">Pólizas que vencen en el mes</a></div>
            <div class="h5 mb-0 font-weight-bold text-gray-800">
              <?= $tratos_vencen ?>
            </div>
          </div>
