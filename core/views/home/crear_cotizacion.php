    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?= $retVal = (!empty($resultado)) ? '?pagina=ver_cotizacion&id=' . $resultado["id"] : "?pagina=crear_cotizacion"; ?>" class="btn btn-primary">Aceptar</a>
            </div>
        </div>
    </div>
</div>
<!-- Modal -->
<form method="post" action="?pagina=crear_cotizacion">
    <div class="text-center">
        <h1 class="h4 text-gray-900 mb-4">Cliente</h1>
    </div>
    ...
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" class="form-control" name="id" required placeholder="RNC/Cédula">
        </div>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        <div class="col-sm-6">
            <input type="text" class="form-control" name="chasis" required placeholder="Chasis">
        </div>
        <div class="col-sm-6">
